...
public class Run_Map {

	@SuppressWarnings("unused")
	public static void Start_Map() throws Exception {
		...
		String[] menuOptions = { "📌 Map = Simple", "📌 Map = If e else if", "📌 Map = For com Matrix",
				"📌 Map = do while com Matrix", "📌 Map = Vetor", "⏪ Voutar para o menu", "👋 Sair 👋 \n" };
