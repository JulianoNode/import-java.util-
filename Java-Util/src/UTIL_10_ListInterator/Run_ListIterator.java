...
public class Run_ListIterator {

	@SuppressWarnings("unused")
	public static void Start_ListIterator() throws Exception {
		...
		String[] menuOptions = { "📌 ListIterator = Simple", "📌 ListIterator = If e else if",
				"📌 ListIterator = For com Matrix", "📌 ListIterator = do while com Matrix", "📌 ListIterator = Vetor",
